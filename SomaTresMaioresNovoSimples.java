/**
 * Este script apresenta uma versão simplificada e direta da lógica de soma dos três maiores números.
 * - Utiliza uma estrutura semelhante ao baseline, mas com verificações e organização mais claras.
 * - Ideal para entender a lógica sem distrações de otimizações complexas.
 * - Não utiliza bibliotecas externas ou técnicas avançadas, mantendo o código fácil de ler.
 */


import java.util.List;

public class SomaTresMaioresNovoSimples {
