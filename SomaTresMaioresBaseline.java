/**
 * Este script implementa uma abordagem básica para calcular a soma dos três maiores números de uma lista.
 * - Se a lista tiver menos de três elementos, soma todos os números disponíveis.
 * - Utiliza três variáveis (`top1`, `top2`, `top3`) para armazenar os maiores valores encontrados.
 * - A cada iteração, ajusta as variáveis conforme necessário.
 * - Não usa bibliotecas avançadas ou técnicas otimizadas, sendo adequado para aprendizado ou listas pequenas.
 */
...
public class SomaTresMaioresBaseline {
